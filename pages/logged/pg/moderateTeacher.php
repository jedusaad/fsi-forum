<div class="full-width" id="moderateTeacher">

	<div class="col-md-12">

		<div class="title">

			<h1> Moderar Professor </h1>
				...
				if ($numPerson == 0) {
					...
					<div class="col-md-12">
						<div class="alert alert-danger">
						  <strong>Aviso!</strong> Não existem usuários na fila.
						</div> 
					</div>';
				}else{
					...
					for ($i = 0; $i< $numPerson; $i++){
						...
						echo '<div class="col-md-12" id="moderateTeacher">
								<div class="col-md-12 moderateTeacherPerson">
						...
						echo '
											 <button class="pull-right btn btn-primary" data-toggle="collapse" data-target="#manage'.$showSelectedPerson['ID'].'"><span class="glyphicon glyphicon-cog"></span> Moderar </button>
										</h4>	
											...
											<div id="manage'.$showSelectedPerson['ID'].'" class="collapse">
												<div class="panel panel-primary">
												  	...
												  	<div class="panel-body">
													  	<form method="post" action="/func/moderateTeacher.php?user='.$showSelectedPerson['ID'].'">
